...
just check         # full validation: agent docs/workflows + laptop-safety + local-bin + flake-update + fmt-check + shell/lid-close/wallpaper + qml-lint + quickshell-test + flake check + eval-all + check-profiles + git diff --check
